...
import br.com.project.listener.ContextLoaderListenerLoja;
...
public class FilterOpenSessionInView extends DelegatingFilterProxy implements Serializable {
	...
	// executa apenas uma vez, quando a aplicação está sendo iniciada
	@Override
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		// JDBC Spring
		BasicDataSource springBasicDataSource = (BasicDataSource) ContextLoaderListenerLoja.getBean("springDataSource");
